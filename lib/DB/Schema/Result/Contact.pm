...
#         FILE:  Contact.pm
#
#  DESCRIPTION:  Contact DB::Schema Result source
#
#        FILES:  ---
#         BUGS:  ---
#        NOTES:  ---
...
__PACKAGE__->add_columns(
		...
		"primary_phone",{ data_type => "VARCHAR(200)", is_nullable => 0 },
		"email_address",{ data_type => "VARCHAR(200)", is_nullable => 0 },
		"business_city", { data_type => "VARCHAR(200)", is_nullable => 0 },
		"web_page", { data_type => "VARCHAR(200)", is_nullable => 0 }
);
